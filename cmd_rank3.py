...
def fetchPlayerRanknev(player):
    ...
    if 150 < player['rank'] <= 160:
        player['ranknev'] = "Petőfi Sándor"
    if 160 < player['rank'] <= 170:
        player['ranknev'] = "Táncsics Mihály"
    if 170 < player['rank']:
        player['ranknev'] = "Thanos"
...
def fetchPlayerRoster(raw_player):
    ...
    fChar(player, raw_player, "COUNTDOOKU", "Count Dooku", 13, 1, 1)
    ...
    fChar(player, raw_player, "SITHMARAUDER", "Sith Marauder", 13, 0, 1)
    ...
    fChar(player, raw_player, "GRANDMOFFTARKIN", "Grand Moff Tarkin", 13, 0, 1)
    fChar(player, raw_player, "VEERS", "General Veers", 13, 0, 1)
    fChar(player, raw_player, "COLONELSTARCK", "Colonel Starck", 13, 0, 1)
