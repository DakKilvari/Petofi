...
class TW(commands.Cog):
    ...
    @commands.command(aliases=['TW-hez guild áttekintő'])
    ...
    async def tw(self, ctx, raw_allycode1, allycode2: int):
        """TW-hez guild áttekintő
        Végigelemzi a teljes guildet előre meghatározott szempontok (főbb statisztikák, karakterek és hajók) alapján.
        raw_allycode1: me / taggelés / allykód saját guildből
        allycode2: ellenfél guild egyik játékosának ally kódja"""
